...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6525_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6526 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6527 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6526);
var pos_6528 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6526);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6527);

var tr__6432__auto___6529 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6527) - cljs.core.first(pos_6528)),(((quil.core.height() / (2)) / zoom_6527) - cljs.core.second(pos_6528))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6432__auto___6529);
...
var G__6530 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6531 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6530,G__6531) : user_mouse_dragged.call(null,G__6530,G__6531));
...
return (function (state,event){
var G__6532 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6533 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6532,G__6533) : user_mouse_wheel.call(null,G__6532,G__6533));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
